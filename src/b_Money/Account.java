...
public class Account {
	...
	public void addTimedPayment(String id, Integer interval, Integer next, Money amount, Bank tobank, String toaccount){
		//if(!timedPaymentExists(id)) throw new AccountExistsException(); //KTR add -> przy pisaniu testu jednostkowego testAddRemoveTimedPayment -> brakowało sprawdzenia, czy istnieje już taki TimePayment
	 ...
	 */
	public void removeTimedPayment(String id) throws NullPointerException{
		if(!timedPaymentExists(id)) throw new NullPointerException("Nie istnieje timepayment o takim id");//KTR add -> przy pisaniu testu jednostkowego testAddRemoveTimedPayment -> brakowało sprawdzenia, czy istnieje taki TimePayment
